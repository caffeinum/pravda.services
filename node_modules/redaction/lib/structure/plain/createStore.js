...
var createStore = function createStore(_ref) {
  ...
  var store = (0, _redux.createStore)((0, _redux.combineReducers)(reducers), initialState, _redux.compose.apply(undefined, [_redux.applyMiddleware.apply(undefined, _toConsumableArray(finalMiddleware))].concat(_toConsumableArray(finalEnhancers))));
